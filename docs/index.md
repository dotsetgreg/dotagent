...
DotAgent is a lean, Discord-first AI agent runtime focused on extensibility through external tools, skills, and toolpacks.
...
- [CLI Reference](reference/cli/dotagent.md)
