...
| `tools.policy.allow` | `array<string>` | `-` | `[]` |
| `tools.policy.default_mode` | `string` | `DOTAGENT_TOOLS_POLICY_DEFAULT_MODE` | `"auto"` |
| `tools.policy.deny` | `array<string>` | `-` | `[]` |
| `tools.policy.provider_modes` | `map<string,string>` | `-` | `-` |
