...
Create and manage recurring or cron-expression based jobs for the agent.
...
* [dotagent cron list](dotagent_cron_list.md)   - List scheduled jobs
* [dotagent cron remove](dotagent_cron_remove.md)   - Remove a scheduled job
